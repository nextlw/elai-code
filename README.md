...
- feat(tui): implement bracketed paste support and update mouse capture handling
- feat(theme): introduce cheese theme palette integration
- feat(init): add Qdrant Docker container management to init command
